...
function AppContent() {
  ...
  return (
    <div className="min-h-screen bg-[#E3F2FD]/50 dark:bg-slate-900 text-slate-800 dark:text-slate-200 font-sans flex flex-col selection:bg-[#0D47A1] selection:text-white relative transition-colors duration-300">
      {showSplash && <SplashScreen onComplete={() => setShowSplash(false)} />}
      
      <header className="bg-white dark:bg-slate-800 border-b border-[#bbdefb] dark:border-slate-700 px-6 py-4 flex items-center justify-between sticky top-0 z-20 shadow-sm transition-colors duration-300">
